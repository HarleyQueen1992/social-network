    ...
    return (
        <div className={s.PostCreationBlock} >
            <header className={s.header} >
                <div className={s.back} onClick={() => {props.toggleIsPostCreation(false)}} ><img className={s.obelus} src={Obelus}/></div>
                <div className={s.newPost} >New post</div>
                <div className={s.save} onClick={addPost} ><img className={s.tick} src={save} /></div>
            </header>
            <div className={s.body} >
                <textarea autoFocus placeholder='Что нового?' ref={newPostElement} className={s.fieldInput} ></textarea>
            </div>
            <div className={s.bot} >
                <div>
                    <img  src={Gallery}/>
